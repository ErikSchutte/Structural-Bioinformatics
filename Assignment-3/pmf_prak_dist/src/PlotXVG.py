...
def parse_xvgs(fnames, sel_columns='all'):
    ...
    xvg_data = []
    for fname in fnames:
        xvg_data.append(parse_xvg(fname, sel_columns=sel_columns))

    combined_metadata, combined_data = xvg_data[0]
    ...
    for metadata, data in xvg_data[1:]:
